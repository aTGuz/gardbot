...
extern void _DS1302_start(void);
extern void _DS1302_stop(void);
extern uint8_t _DS1302_toggleread(void);
extern void _DS1302_togglewrite(uint8_t data, uint8_t release);
